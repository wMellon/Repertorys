...
#import "ImageTextMsgCell.h"
#import "SDAutoLayout.h"

@implementation ImageTextMsgCell
...
- (void)setupContentView{
    ...
    [_msgBodyView sd_addSubviews:@[_titleLabel,imageView,_contentLabel]];
...
- (void)setModel:(NSObject<MsgCellModelProtocol>*)model{
    ...
    if(model.imageUrlStr.length > 0){
        ...
        .autoHeightRatio(0.56);
        imageTopOffset = 10;
//        [imageView sd_setImageWithURL:[NSURL URLWithString:model.imageUrlStr]];
    }
    imageView.sd_layout.topSpaceToView(_titleLabel, imageTopOffset);
    ...
    if(model.content.length > 0){
        _contentLabel.sd_layout
        .heightIs(_contentLabel.font.lineHeight);
    }else{
        _contentLabel.sd_layout
        .autoHeightRatio(0);
    }
